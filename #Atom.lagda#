...
--
lemma∙ₐa≢b∧a≢c∧a≢（bc）d→a≢d : ∀ {a b c d} → a ≢ b → a ≢ c → a ≢ （ b ∙ c ）ₐ d → a ≢ d
lemma∙ₐa≢b∧a≢c∧a≢（bc）d→a≢d {a} {b} {c} {d} a≢b a≢c a≢（bc）d with （ b ∙ c ）ₐ d | lemma∙ₐ b c d
lemma∙ₐa≢b∧a≢c∧a≢（bc）d→a≢d {a} {b} {c} .{b} a≢b a≢c a≢（bc）d | .c | inj₁ (refl , refl)              = a≢b
...
lemma∙ₐ（ab）c≢a∧（ab）c≢b→（ab）c≡a {a} {b} {c}  （ab）c≢a （ab）c≢b  with （ a ∙ b ）ₐ c | lemma∙ₐ a b c
