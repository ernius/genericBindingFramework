...
\begin{code}%
\>\AgdaKeyword{infix} \AgdaNumber{11} \AgdaFixityOp{\_[\_≔\_]ₙ}\<%
\\
\>\AgdaKeyword{infix} \AgdaNumber{11} \AgdaFixityOp{\_[\_≔\_]}\<%
\\
\>\<%
\end{code}
...
\>[59]\AgdaSymbol{=} \AgdaFunction{v} \AgdaBound{y} \<[65]%
\>[65]\<%
\\
%
\\
...
\>[14]\AgdaSymbol{=} \AgdaFunction{foldCtxα} \<[26]%
\>[26]\AgdaFunction{tF} \AgdaFunction{substaux} \AgdaSymbol{(}\AgdaInductiveConstructor{⟨} \AgdaBound{x} \AgdaInductiveConstructor{,} \AgdaBound{N} \AgdaInductiveConstructor{⟩}\AgdaSymbol{)} \AgdaBound{M} \<%
\end{code}
%</subst>
...
%
\\
\>\AgdaKeyword{infix} \AgdaNumber{9} \AgdaFixityOp{（\_∙\_）\_}\<%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{=} \AgdaFunction{lemma-foldCtxαCtx} \AgdaFunction{lemma-substaux} \AgdaSymbol{(}\AgdaInductiveConstructor{∼αR} \AgdaSymbol{(}\AgdaInductiveConstructor{∼αx} \AgdaInductiveConstructor{∼αV} \AgdaSymbol{(}\AgdaInductiveConstructor{∼αEf} \AgdaBound{N∼N′}\AgdaSymbol{)))} \AgdaBound{M}\<%
\end{code}
...
\\
\> \AgdaSymbol{=} \AgdaFunction{lemma-foldCtxα-foldCtx}\<%
\\
\>[0]\AgdaIndent{6}{}\<[6]%
...
\\
\>\AgdaFunction{PSCn} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{L}\AgdaSymbol{\}} \AgdaBound{N} \AgdaBound{M}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{=} \<[5]%
\>[5]\AgdaBound{x} \AgdaFunction{∉} \AgdaBound{y} \AgdaInductiveConstructor{∷} \AgdaFunction{fv} \AgdaBound{L}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{→} \<[5]%
\>[5]\AgdaBound{x} \AgdaFunction{notOccurBind} \AgdaBound{L}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{→} \<[5]%
...
\>[27]\AgdaSymbol{\{}\AgdaBound{x} \AgdaBound{y} \AgdaSymbol{:} \AgdaFunction{V}\AgdaSymbol{\}\{}\AgdaBound{M} \AgdaBound{N} \AgdaBound{L} \AgdaSymbol{:} \AgdaFunction{FTerm}\AgdaSymbol{\}}\<%
\\
\>[11]\AgdaIndent{27}{}\<[27]%
\>[27]\AgdaSymbol{→} \AgdaFunction{PSCn} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{L}\AgdaSymbol{\}} \AgdaBound{N} \AgdaBound{M}\<%
\\
...
\>[30]\AgdaSymbol{(}\AgdaInductiveConstructor{inj₂} \AgdaSymbol{(}\AgdaInductiveConstructor{inj₂} \AgdaSymbol{(}\AgdaInductiveConstructor{inj₁} \AgdaSymbol{(}\AgdaBound{t} \AgdaInductiveConstructor{,} \AgdaBound{z} \AgdaInductiveConstructor{,} \AgdaBound{M}\AgdaSymbol{))))} \AgdaSymbol{(\_} \AgdaInductiveConstructor{,} \AgdaBound{hiM}\AgdaSymbol{)} \<[73]%
\>[73]\<%
\\
\>[2]\AgdaIndent{30}{}\<[30]%
\>[30]\AgdaBound{x∉yfvL} \<[39]%
\>[39]\AgdaBound{xnbL} \<[45]%
\>[45]\AgdaSymbol{=} \<[48]%
\>[48]\<%
\\
\>[0]\AgdaIndent{4}{}\<[4]%
...
\\
\>[0]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{≈⟨} \AgdaInductiveConstructor{refl} \<[68]%
\>[68]\AgdaFunction{⟩}\<%
\\
\>[4]\AgdaIndent{6}{}\<[6]%
...
\\
\>[0]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{∼⟨} \AgdaInductiveConstructor{∼αR} \AgdaSymbol{(}\AgdaInductiveConstructor{∼α+₂} \AgdaSymbol{(}\AgdaInductiveConstructor{∼α+₂} \AgdaSymbol{(}\AgdaInductiveConstructor{∼α+₁} \<[29]%
\>[29]\<%
\\
\>[4]\AgdaIndent{28}{}\<[28]%
\>[28]\AgdaSymbol{(}\AgdaInductiveConstructor{∼αx} \<[34]%
\>[34]\AgdaFunction{ρF} \<[37]%
\>[37]\<%
\\
\>[28]\AgdaIndent{34}{}\<[34]%
\>[34]\AgdaSymbol{(}\AgdaFunction{lemma∼+B} \AgdaSymbol{(}\AgdaBound{hiM} \AgdaBound{x∉yfvL} \AgdaBound{xnbL}\AgdaSymbol{))))))} \<[68]%
\>[68]\AgdaFunction{⟩} \<[70]%
\>[70]\<%
\\
\>[0]\AgdaIndent{6}{}\<[6]%
...
\begin{code}%
\>\AgdaFunction{αCompatiblePSComp} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{x} \AgdaBound{y} \AgdaSymbol{:} \AgdaFunction{V}\AgdaSymbol{\}} \<[32]%
\>[32]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{→} \AgdaFunction{αCompatiblePred} \AgdaSymbol{\{}\AgdaFunction{TreeFTermF}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaFunction{PSComp} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\})}\<%
\\
...
\\
\>[0]\AgdaIndent{5}{}\<[5]%
\>[5]\AgdaFunction{≈⟨} \AgdaFunction{cong} \AgdaSymbol{(λ} \AgdaBound{z} \AgdaSymbol{→} \AgdaBound{z} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{≔} \AgdaBound{L′} \AgdaFunction{]}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{lemma-substα} \AgdaSymbol{(}\AgdaFunction{σ} \AgdaFunction{M∼M'}\AgdaSymbol{))} \<[62]%
\>[62]\AgdaFunction{⟩}\<%
\\
\>[5]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaSymbol{(}\AgdaBound{M} \<[12]%
...
\>[22]\AgdaSymbol{\{}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{≔} \AgdaBound{N′} \AgdaFunction{]}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{≔} \AgdaBound{N} \AgdaFunction{]}\AgdaSymbol{\}}\<%
\\
\>[5]\AgdaIndent{22}{}\<[22]%
\>[22]\AgdaSymbol{(}\AgdaFunction{lemma-substα′} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaFunction{σ} \AgdaFunction{N∼N'}\AgdaSymbol{))} \<[62]%
\>[62]\AgdaFunction{⟩}\<%
\\
\>[0]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaSymbol{(}\AgdaBound{M} \<[12]%
...
\>[39]\AgdaFunction{]}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaFunction{σ} \AgdaFunction{L∼L'}\AgdaSymbol{)} \<[62]%
\>[62]\AgdaFunction{⟩}\<%
\\
\>[5]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaSymbol{(}\AgdaBound{M} \<[12]%
...
\\
\>[0]\AgdaIndent{5}{}\<[5]%
\>[5]\AgdaFunction{∼⟨} \AgdaBound{PMs} \AgdaFunction{x∉y∶fvL} \<[62]%
\>[62]\AgdaFunction{⟩} \<[64]%
\>[64]\<%
\\
\>[5]\AgdaIndent{7}{}\<[7]%
...
\>[14]\AgdaSymbol{(λ} \AgdaBound{P} \AgdaSymbol{→} \AgdaBound{P} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{≔} \AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{≔} \AgdaBound{L} \AgdaFunction{]} \AgdaFunction{]}\AgdaSymbol{)} \<[44]%
\>[44]\<%
\\
\>[5]\AgdaIndent{14}{}\<[14]%
\>[14]\AgdaSymbol{(}\AgdaFunction{lemma-substα} \AgdaFunction{M∼M'}\AgdaSymbol{)} \<[62]%
\>[62]\AgdaFunction{⟩} \<[64]%
\>[64]\<%
\\
\>[0]\AgdaIndent{7}{}\<[7]%
...
\>[0]\AgdaIndent{5}{}\<[5]%
\>[5]\AgdaFunction{≈⟨} \AgdaFunction{lemma-substα} \<[22]%
\>[22]\AgdaSymbol{\{}\AgdaBound{M′} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{≔} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M′} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{≔} \AgdaBound{L′} \AgdaFunction{]}\AgdaSymbol{\}} \<[53]%
\>[53]\<%
\\
\>[5]\AgdaIndent{22}{}\<[22]%
\>[22]\AgdaSymbol{\{}\AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{≔} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}}\<%
\\
\>[5]\AgdaIndent{22}{}\<[22]%
\>[22]\AgdaSymbol{(}\AgdaFunction{lemma-substα′} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M′}\AgdaSymbol{\}} \AgdaFunction{L∼L'}\AgdaSymbol{)} \<[62]%
\>[62]\AgdaFunction{⟩} \<[71]%
\>[71]\<%
\\
\>[0]\AgdaIndent{7}{}\<[7]%
...
\>[38]\AgdaFunction{[} \AgdaBound{x} \AgdaFunction{≔} \AgdaBound{P} \AgdaFunction{]}\AgdaSymbol{)} \<[49]%
\>[49]\<%
\\
\>[5]\AgdaIndent{14}{}\<[14]%
\>[14]\AgdaSymbol{(}\AgdaFunction{lemma-substα} \AgdaFunction{N∼N'}\AgdaSymbol{)} \<[62]%
\>[62]\AgdaFunction{⟩}\<%
\\
\>[0]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaSymbol{(}\AgdaBound{M′} \<[12]%
...
\>[32]\AgdaFunction{[} \AgdaBound{y} \AgdaFunction{≔} \AgdaBound{L′} \AgdaFunction{]}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N′} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{≔} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{\}}\<%
\\
\>[5]\AgdaIndent{23}{}\<[23]%
\>[23]\AgdaSymbol{(}\AgdaFunction{lemma-substα′} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N′}\AgdaSymbol{\}} \AgdaFunction{L∼L'}\AgdaSymbol{)} \<[62]%
\>[62]\AgdaFunction{⟩} \<[64]%
\>[64]\<%
\\
\>[0]\AgdaIndent{7}{}\<[7]%
...
\begin{code}%
\>\AgdaFunction{αproof} \AgdaSymbol{:} \<[10]%
\>[10]\AgdaSymbol{\{}\AgdaBound{x} \AgdaBound{y} \AgdaSymbol{:} \AgdaFunction{V}\AgdaSymbol{\}(}\AgdaBound{Ms} \AgdaSymbol{:} \AgdaDatatype{μ} \AgdaFunction{TreeFTermF}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{11}{}\<[11]%
\>[11]\AgdaSymbol{→} \AgdaFunction{ListNotOccurBind} \AgdaSymbol{(}\AgdaBound{x} \AgdaInductiveConstructor{∷} \AgdaBound{y} \AgdaInductiveConstructor{∷} \AgdaInductiveConstructor{[]}\AgdaSymbol{)} \AgdaBound{Ms} \<[46]%
\>[46]\<%
\\
\>[2]\AgdaIndent{11}{}\<[11]%
\>[11]\AgdaSymbol{→} \AgdaFunction{ListNotOccurBind} \AgdaSymbol{(}\AgdaFunction{fv} \AgdaBound{Ms}\AgdaSymbol{)} \AgdaBound{Ms}\<%
\\
\>[2]\AgdaIndent{11}{}\<[11]%
\>[11]\AgdaSymbol{→} \AgdaFunction{PSComp} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\}} \AgdaBound{Ms}\<%
\\
\>\AgdaFunction{αproof} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\}} \AgdaInductiveConstructor{⟨} \AgdaBound{M} \AgdaInductiveConstructor{,} \AgdaBound{N} \AgdaInductiveConstructor{,} \AgdaBound{L} \AgdaInductiveConstructor{⟩} \AgdaBound{nOcc} \AgdaBound{nOcc2} \AgdaBound{x∉y∶fvL}\<%
\\
\>[0]\AgdaIndent{3}{}\<[3]%
\>[3]\AgdaSymbol{=} \<[6]%
...
\>[23]\AgdaSymbol{\{}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{≔} \AgdaBound{N} \AgdaFunction{]}\AgdaSymbol{\}} \<[37]%
\>[37]\<%
\\
\>[6]\AgdaIndent{23}{}\<[23]%
\>[23]\AgdaSymbol{(}\AgdaFunction{lemmaSubsts} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}} \AgdaFunction{x:fvN∉bM}\AgdaSymbol{)} \<[62]%
\>[62]\AgdaFunction{⟩}\<%
\\
\>[0]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaBound{M} \<[13]%
...
\\
\>[0]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaFunction{∼⟨} \AgdaFunction{lemmaSubsts} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{≔} \AgdaBound{N} \AgdaFunction{]ₙ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{L}\AgdaSymbol{\}} \AgdaFunction{y:fvL∉bM[x≔N]ₙ} \<[62]%
\>[62]\AgdaFunction{⟩}\<%
\\
\>[6]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaBound{M} \<[13]%
...
\>[34]\AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{L}\AgdaSymbol{\}} \<[54]%
\>[54]\<%
\\
\>[6]\AgdaIndent{34}{}\<[34]%
\>[34]\AgdaBound{x∉y∶fvL} \AgdaFunction{x∉bL} \<[62]%
\>[62]\AgdaFunction{⟩}\<%
\\
\>[0]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaBound{M} \<[13]%
...
\>[25]\AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{≔} \AgdaBound{L} \AgdaFunction{]ₙ}\AgdaSymbol{\}} \<[44]%
\>[44]\<%
\\
\>[6]\AgdaIndent{25}{}\<[25]%
\>[25]\AgdaSymbol{(}\AgdaFunction{σ} \AgdaSymbol{(}\AgdaFunction{lemmaSubsts} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}} \AgdaFunction{y:fvL∉bN}\AgdaSymbol{))} \<[62]%
\>[62]\AgdaFunction{⟩}\<%
\\
\>[0]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaBound{M} \<[13]%
...
\>[25]\AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{≔} \AgdaBound{L} \AgdaFunction{]ₙ}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{≔} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{\}} \<[58]%
\>[58]\<%
\\
\>[6]\AgdaIndent{25}{}\<[25]%
\>[25]\AgdaFunction{x:fvN[y≔L]∉bM[y≔L]ₙ}\AgdaSymbol{)} \<[62]%
\>[62]\AgdaFunction{⟩}\<%
\\
\>[0]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaBound{M} \<[13]%
...
\\
\>[0]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaFunction{≈⟨} \AgdaFunction{lemma-substα} \AgdaSymbol{(}\AgdaFunction{σ} \AgdaSymbol{(}\AgdaFunction{lemmaSubsts} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{L}\AgdaSymbol{\}} \AgdaFunction{y:fvL∉bM}\AgdaSymbol{))} \<[62]%
\>[62]\AgdaFunction{⟩}\<%
\\
\>[6]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaSymbol{(}\AgdaBound{M} \<[13]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{x:fvN∉bM} \AgdaSymbol{=} \AgdaPostulate{lemma-binds:cons} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:head} \AgdaFunction{x:y∉bM}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaPostulate{lemma-binds++l} \AgdaSymbol{(}\AgdaPostulate{lemma-binds++r} \AgdaSymbol{\{}\AgdaFunction{fv} \AgdaBound{M}\AgdaSymbol{\}} \AgdaFunction{fvM++fvN++fvL∉bM}\AgdaSymbol{))}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{x∉bL} \AgdaSymbol{:} \AgdaBound{x} \AgdaFunction{notOccurBind} \AgdaBound{L}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{x∉bL} \AgdaSymbol{=} \AgdaPostulate{lemma-binds:head} \AgdaFunction{x:y∉bL}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{y:fvL∉bM} \AgdaSymbol{=} \AgdaPostulate{lemma-binds:cons} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:head} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:tail} \AgdaFunction{x:y∉bM}\AgdaSymbol{))} \AgdaSymbol{(}\AgdaPostulate{lemma-binds++r} \AgdaSymbol{\{}\AgdaFunction{fv} \AgdaBound{N}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaPostulate{lemma-binds++r} \AgdaSymbol{\{}\AgdaFunction{fv} \AgdaBound{M}\AgdaSymbol{\}} \AgdaFunction{fvM++fvN++fvL∉bM}\AgdaSymbol{))}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{y:fvL∉bN} \AgdaSymbol{=} \AgdaPostulate{lemma-binds:cons} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:head} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:tail} \AgdaFunction{x:y∉bN}\AgdaSymbol{))} \AgdaSymbol{(}\AgdaPostulate{lemma-binds++r} \AgdaSymbol{\{}\AgdaFunction{fv} \AgdaBound{N}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaPostulate{lemma-binds++r} \AgdaSymbol{\{}\AgdaFunction{fv} \AgdaBound{M}\AgdaSymbol{\}} \AgdaFunction{fvM++fvN++fvL∉bN}\AgdaSymbol{))}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{=} \AgdaPostulate{lemma-foldCtxBinds} \AgdaSymbol{\{}\AgdaFunction{cF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{tF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{tF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{substaux}\AgdaSymbol{\}} \AgdaFunction{y:fvL∉bM} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:cons} \AgdaSymbol{(}\AgdaInductiveConstructor{notOccurBR} \AgdaSymbol{(}\AgdaInductiveConstructor{notOccurBx} \AgdaInductiveConstructor{notOccurBv} \AgdaSymbol{(}\AgdaFunction{notOccurBindR→notOccurBindEf} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:head} \AgdaFunction{y:fvL∉bN}\AgdaSymbol{))))} \AgdaSymbol{(}\AgdaFunction{lemma-bindsR} \AgdaSymbol{(}\AgdaFunction{lemma-binds×} \AgdaFunction{lemma-bindsv} \AgdaSymbol{(}\AgdaFunction{lemmalistNotOccurBindFR→ListNotOccurBindEf} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:tail} \AgdaFunction{y:fvL∉bN}\AgdaSymbol{)))))}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{[x]∉bM[y≔L]ₙ} \AgdaSymbol{=} \AgdaPostulate{lemma-foldCtxBinds} \AgdaSymbol{\{}\AgdaFunction{cF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{tF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{tF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{substaux}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:cons} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:head} \AgdaFunction{x:y∉bM} \AgdaSymbol{)} \AgdaInductiveConstructor{[]}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{lemma-bindsR} \AgdaSymbol{(} \AgdaFunction{lemma-binds×} \AgdaSymbol{(}\AgdaInductiveConstructor{notOccurBv} \AgdaInductiveConstructor{∷} \AgdaInductiveConstructor{[]}\AgdaSymbol{)} \AgdaSymbol{(} \AgdaFunction{lemmalistNotOccurBindFR→ListNotOccurBindEf} \AgdaSymbol{(} \AgdaPostulate{lemma-binds:cons} \<[223]%
\>[223]\AgdaSymbol{(}\AgdaPostulate{lemma-binds:head} \AgdaFunction{x:y∉bL}\AgdaSymbol{)} \AgdaInductiveConstructor{[]}\AgdaSymbol{))))}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{fv⟨y,L⟩∉bM} \AgdaSymbol{\{}\AgdaInductiveConstructor{⟨} \AgdaBound{L} \AgdaInductiveConstructor{⟩}\AgdaSymbol{\}} \AgdaBound{y:fvL∉bM} \AgdaSymbol{=} \AgdaPostulate{lemma-binds:cons} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:head} \AgdaBound{y:fvL∉bM}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:tail} \AgdaBound{y:fvL∉bM}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{y∉bL} \AgdaSymbol{:} \AgdaBound{y} \AgdaFunction{notOccurBind} \AgdaBound{L}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{y∉bL} \AgdaSymbol{=} \AgdaPostulate{lemma-binds:head} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:tail} \AgdaFunction{x:y∉bL}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{fvL∉bL} \AgdaSymbol{=} \AgdaPostulate{lemma-binds++r} \AgdaSymbol{\{}\AgdaFunction{fv} \AgdaBound{N}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaPostulate{lemma-binds++r} \AgdaSymbol{\{}\AgdaFunction{fv} \AgdaBound{M}\AgdaSymbol{\}} \AgdaFunction{fvM++fvN++fvL∉bL}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{fv⟨y,L⟩∉b⟨y,L⟩} \AgdaSymbol{\{}\AgdaInductiveConstructor{⟨} \AgdaBound{L} \AgdaInductiveConstructor{⟩}\AgdaSymbol{\}} \AgdaBound{y∉bL} \AgdaBound{fvL∉bL} \AgdaSymbol{=} \AgdaPostulate{lemma-binds:cons} \AgdaSymbol{(}\AgdaInductiveConstructor{notOccurBR} \AgdaSymbol{(}\AgdaInductiveConstructor{notOccurBx} \AgdaInductiveConstructor{notOccurBv} \AgdaSymbol{(}\AgdaInductiveConstructor{notOccurBEf} \AgdaSymbol{(}\AgdaFunction{notOccurBRinv} \AgdaBound{y∉bL}\AgdaSymbol{))))} \AgdaSymbol{((}\AgdaFunction{lemma-bindsR} \AgdaSymbol{(}\AgdaFunction{lemma-binds×} \AgdaFunction{lemma-bindsv} \AgdaSymbol{(}\AgdaFunction{lemmalistNotOccurBindFR→ListNotOccurBindEf} \AgdaBound{fvL∉bL}\AgdaSymbol{))))}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{=} \AgdaPostulate{lemma-binds⊆} \<[20]%
...
\\
\>[4]\AgdaIndent{20}{}\<[20]%
\>[20]\AgdaSymbol{(}\AgdaPostulate{foldCtxFV} \AgdaSymbol{\{}\AgdaFunction{cF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{tF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{tF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaInductiveConstructor{⟨} \AgdaBound{y} \AgdaInductiveConstructor{,} \AgdaBound{L} \AgdaInductiveConstructor{⟩}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{substaux}\AgdaSymbol{\})} \<[74]%
\>[74]\<%
\\
\>[4]\AgdaIndent{20}{}\<[20]%
\>[20]\AgdaSymbol{(}\AgdaPostulate{lemma-binds++} \<[36]%
...
\\
\>[20]\AgdaIndent{36}{}\<[36]%
\>[36]\AgdaSymbol{(}\AgdaPostulate{lemma-foldCtxBinds} \<[57]%
\>[57]\AgdaSymbol{\{}\AgdaFunction{cF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{tF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{tF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{substaux}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaInductiveConstructor{⟨} \AgdaBound{y} \AgdaInductiveConstructor{,} \AgdaBound{L} \AgdaInductiveConstructor{⟩}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{fv} \AgdaSymbol{\{}\AgdaFunction{cF}\AgdaSymbol{\}} \AgdaInductiveConstructor{⟨} \AgdaBound{y} \AgdaInductiveConstructor{,} \AgdaBound{L} \AgdaInductiveConstructor{⟩}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaFunction{fv⟨y,L⟩∉bM} \AgdaSymbol{\{}\AgdaBound{L}\AgdaSymbol{\}} \AgdaFunction{y:fvL∉bM}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{fv⟨y,L⟩∉b⟨y,L⟩} \AgdaSymbol{\{}\AgdaBound{L}\AgdaSymbol{\}} \AgdaFunction{y∉bL} \AgdaFunction{fvL∉bL}\AgdaSymbol{))}\<%
\\
\>[20]\AgdaIndent{36}{}\<[36]%
\>[36]\AgdaSymbol{(}\AgdaPostulate{lemma-foldCtxBinds} \<[57]%
\>[57]\AgdaSymbol{\{}\AgdaFunction{cF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{tF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{tF}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{substaux}\AgdaSymbol{\}} \<[83]%
\>[83]\<%
\\
\>[36]\AgdaIndent{57}{}\<[57]%
\>[57]\AgdaSymbol{(}\AgdaPostulate{lemma-binds++l} \AgdaSymbol{(}\AgdaPostulate{lemma-binds++r} \AgdaSymbol{\{}\AgdaFunction{fv} \AgdaBound{M}\AgdaSymbol{\}} \AgdaFunction{fvM++fvN++fvL∉bM}\AgdaSymbol{))}\<%
\\
\>[36]\AgdaIndent{57}{}\<[57]%
\>[57]\AgdaSymbol{(}\AgdaFunction{lemma-bindsR} \AgdaSymbol{(} \AgdaFunction{lemma-binds×} \AgdaFunction{lemma-bindsv} \AgdaSymbol{(}\AgdaFunction{lemmalistNotOccurBindFR→ListNotOccurBindEf} \AgdaSymbol{(}\AgdaPostulate{lemma-binds++l} \AgdaSymbol{(}\AgdaPostulate{lemma-binds++r} \AgdaSymbol{\{}\AgdaFunction{fv} \AgdaBound{M}\AgdaSymbol{\}} \AgdaFunction{fvM++fvN++fvL∉bL}\AgdaSymbol{)))))))}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{x:fvN[y≔L]ₙ∉bM[y≔L]ₙ} \AgdaSymbol{=} \AgdaPostulate{lemma-binds:cons} \AgdaSymbol{(}\AgdaPostulate{lemma-binds:head} \AgdaFunction{[x]∉bM[y≔L]ₙ}\AgdaSymbol{)} \AgdaFunction{fvN[y≔L]ₙ∉bM[y≔L]ₙ}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\>[25]\AgdaSymbol{:} \<[28]%
\>[28]\AgdaSymbol{\{}\AgdaBound{x} \AgdaBound{y} \AgdaSymbol{:} \AgdaFunction{V}\AgdaSymbol{\}\{}\AgdaBound{Ms} \AgdaSymbol{:} \AgdaFunction{TreeFTerm}\AgdaSymbol{\}} \<[54]%
\>[54]\<%
\\
\>[2]\AgdaIndent{25}{}\<[25]%
\>[25]\AgdaSymbol{→} \<[28]%
\>[28]\AgdaFunction{PSComp} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\}} \AgdaBound{Ms}\<%
\\
...
\\
\> \AgdaSymbol{=} \AgdaFunction{αProof} \<[11]%
\>[11]\AgdaSymbol{(}\AgdaFunction{PSComp} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{y}\AgdaSymbol{\})}\<%
\\
\>[0]\AgdaIndent{11}{}\<[11]%
\>[11]\AgdaSymbol{(}\AgdaBound{x} \AgdaInductiveConstructor{∷} \AgdaBound{y} \AgdaInductiveConstructor{∷} \AgdaInductiveConstructor{[]}\AgdaSymbol{)} \<[24]%
\>[24]\<%
\\
\>[0]\AgdaIndent{11}{}\<[11]%
...
\>[36]\<%
\\
\>\AgdaKeyword{infix} \AgdaNumber{7} \AgdaFixityOp{\_⇉n\_}\<%
\\
\>\<%
\end{code}
